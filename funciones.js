...
function homepage()
{
	 location.href = "http://www.procalivalle.com.co";
}
...
function validaForm()
{
	...
	if(error==1)
	{
		var texto="<img src='contactenos/error.gif' alt='Error'><br><br>Error: revisar los campos.<br><br><button style='width:45px; height:18px; font-size:10px;' onClick='ocultaMensaje()' type='button'>Ok</button>";
		muestraMensaje(texto);
	}
	else
	{
		var texto="<img src='contactenos/loading.gif' alt='Enviando'><br>Enviando. Por favor espere.<br><br><button style='width:60px; height:18px; font-size:10px;' onClick='ocultaMensaje()' type='button'>Ocultar</button>";
		muestraMensaje(texto);
		...
		ajax.onreadystatechange=function()
		{
			if (ajax.readyState==4)
			{
				...
				if(respuesta=="OK")
				{
					var texto="<img src='contactenos/ok.gif' alt='Ok'><br>Gracias por su mensaje.<br>Le responderemos a la brevedad.<br><br><button style='width:45px; height:18px; font-size:10px;' onClick='homepage()' type='button'>Ok</button>";
				limpiaForm();
				}
				else var texto="<img src='contactenos/error.gif'><br><br>Error: intente más tarde.<br><br><button style='width:45px; height:18px; font-size:10px;' onClick='ocultaMensaje()' type='button'>Ok</button>";
